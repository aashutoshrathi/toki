...
const LOGOS = {
  ...
  zed: '<svg class="plogo" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" clip-rule="evenodd" d="M5 1.5h14A3.5 3.5 0 0 1 22.5 5v14a3.5 3.5 0 0 1-3.5 3.5H5A3.5 3.5 0 0 1 1.5 19V5A3.5 3.5 0 0 1 5 1.5Zm1.6 4.2h10.8v2.6l-6.6 7.1h6.6v3H6.6v-2.6l6.6-7.1H6.6v-3Z"/></svg>',
};
